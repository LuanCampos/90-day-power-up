...
function normalizeLoadedChallengeData(parsed: Partial<ChallengeData>): ChallengeData {
  ...
  return {
    ...
    workoutTemplates: resolveTemplates<WorkoutTemplate>(parsed.workoutTemplates as WorkoutTemplate[] | undefined, defaultWorkoutTemplates, workoutsHaveNewShape),
    cardioTemplates: resolveTemplates<CardioTemplate>(parsed.cardioTemplates as CardioTemplate[] | undefined, defaultCardioTemplates, () => true),
